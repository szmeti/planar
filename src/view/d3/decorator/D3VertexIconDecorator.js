...
var D3VertexIconDecorator = (function () {
  ...
  utils.mixin(D3VertexIconDecorator.prototype, {
    ...
    doInitDefs: function (defs) {
      defs.append('path').attr('id', 'icon-spam').attr('d', 'M16 11.5l-4.5-11.5h-7l-4.5 4.5v7l4.5 ' +
        '4.5h7l4.5-4.5v-7l-4.5-4.5zM9 13h-2v-2h2v2zM9 9h-2v-6h2v6z');

      defs.append('path').attr('id', 'icon-airplane').attr('d', 'M12 9.999l-2.857-2.857 6.857-5.143-2-2-8.571 ' +
