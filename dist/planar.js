    ...
    var D3VertexManager = function() {
        ...
        utils.mixin(D3VertexManager.prototype, {
            addDragToVertices: function() {
                ...
                drag.origin(function(uiVertex) {'use strict';
                    return uiVertex;
                });
    ...
    var settings = {
        ...
        icons: {
            ...
            iconSet: {
                ...
                cross: "M11.479 10.522l-2.206-2.522 2.206-2.522c0.375-0.375 0.375-0.983 0-1.358s-0.983-0.374-1.358 0l-2.122 " + "2.425-2.121-2.424c-0.375-0.375-0.983-0.375-1.358 0s-0.374 0.983 0 1.358l2.206 2.521-2.206 2.522c-0.374 " + "0.375-0.374 0.982 0 1.356s0.983 0.375 1.358 0l2.122-2.423 2.121 2.423c0.375 0.375 0.983 0.375 1.358 " + "0s0.375-0.981 0.001-1.356z",
                remove: "M3 16h10l1-11h-12zM10 2v-2h-4v2h-5v3l1-1h12l1 1v-3h-5zM9 2h-2v-1h2v1z",
                remove2: "M12.5 2h-9c-0.828 0-1.5 0.672-1.5 1.5v0.5h12v-0.5c0-0.828-0.672-1.5-1.5-1.5zM9.88 1l0.221 " + "1.578h-4.201l0.221-1.578h3.76zM10 0h-4c-0.412 0-0.797 0.334-0.854 0.743l-0.292 2.093c-0.057 0.409 0.234 " + "0.743 0.646 0.743h5c0.412 0 0.703-0.334 0.646-0.743l-0.292-2.093c-0.057-0.409-0.441-0.743-0.854-0.743v0zM12.75 " + "5h-9.5c-0.55 0-0.959 0.448-0.909 0.996l0.819 9.008c0.050 0.548 0.541 0.996 1.091 0.996h7.5c0.55 0 1.041-0.448 " + "1.091-0.996l0.819-9.008c0.050-0.548-0.359-0.996-0.909-0.996zM6 14h-1.5l-0.5-7h2v7zM9 14h-2v-7h2v7zM11.5 " + "14h-1.5v-7h2l-0.5 7z",
